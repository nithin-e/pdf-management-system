...
const PDFTaskUI: React.FC = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen bg-gray-50">
        <Navbar />
      <div className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8  mt-4">
        <div className="max-w-5xl mx-auto">
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Click on pages to select them for extraction. Selected pages will
              be included in the new PDF.
            </p>
          </div>
      ...
      <div className="w-full lg:w-96 bg-white border-t lg:border-t-0 lg:border-l border-gray-200 overflow-y-auto">
        {fileData ? (
          <>
            <div className="p-4 sm:p-6 border-b border-gray-200 mt-12">
            ...
            <div className="p-4 sm:p-6">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-gray-900">{numPages}</span>
                </div>
                <div className="flex justify-between">
